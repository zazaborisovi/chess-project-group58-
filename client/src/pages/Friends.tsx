          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div>
              ...
              <p className="text-base text-slate-400 mt-2">
                Manage your connections and game invites.
              </p>
            </div>
          </div>
        </header>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4 mb-6">
            <h2 className="text-xs font-black uppercase tracking-[0.25em] text-slate-500 whitespace-nowrap">
              Your Connections ({filteredFriends?.length || 0})
            </h2>
            ...
            {filteredFriends?.map((friend, index) => (
              ...
              >
                ...
                <div className="flex w-full items-center gap-3 sm:w-auto">
                  ...
                  <button
                    className="flex-1 rounded-xl bg-indigo-600 px-6 py-3 text-sm font-bold text-white transition hover:bg-indigo-500 sm:flex-none shadow-lg shadow-indigo-900/20"
